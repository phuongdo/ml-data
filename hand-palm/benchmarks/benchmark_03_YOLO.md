...
## Model 03_YOLO - 50steps TestDate: 23/01/2018

Overall: (Positives: 24 imgs, Negatives :  62 imgs)

* TP: 20, FP: 4, FN : 9, TN : 53
* Sensitivity: TP/(TP+FN) = 	`68.97%`
* Specificity:  TN/(FP+ TN) = `92.98%`	
* Accuracy : `84.88%` 
...
https://raw.githubusercontent.com/phuongdo/ml-data/master/hand-palm/test-pos/IMG_011.jpg	negative	x
...
https://raw.githubusercontent.com/phuongdo/ml-data/master/hand-palm/test-neg/IMG_054.jpg	positive	x
